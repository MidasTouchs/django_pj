...
from classroom.views import Categories, CategoryCourses, NewCourse, Enroll, CourseDetail, DeleteCourse, EditCourse, MyCourses, CourseDetail, Submissions, StudentSubmissions, GradeSubmission
...
urlpatterns = [
	...
	# path('<course_id>/delete', DeleteModule, name='delete-module'),
	# #Pages
